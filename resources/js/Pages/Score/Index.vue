...
const sortFn = (a, b) => {
    if (sort.value === 'TITLE') {
        ...
        return reverse.value
            ? lamps.indexOf(b.lamp) - lamps.indexOf(a.lamp)
            : lamps.indexOf(a.lamp) - lamps.indexOf(b.lamp);
                ...
                <div class="mb-2">
                    ...
                    <div>
                        ...
                        <span v-for="difficulty in ['B', 'N', 'H', 'A', 'L']" class="inline-block ml-2 mb-2">
                            ...
                            <SecondaryButton v-else @click="filter.difficulty = difficulty">{{
                                difficulty
                            }}</SecondaryButton>
                        </span>
                    </div>
                    <div>
                        ...
                        <span v-for="level in [...Array(12)].map((_, i) => i + 1)" class="inline-block ml-2 mb-2">
                            <PrimaryButton v-if="filter.level === level" @click="filter.level = null">{{
                                level
                            }}</PrimaryButton>
                    ...
                    <div>
                        ...
                        <span v-for="lamp in ['FC', 'EX', 'HC', 'NC', 'EC', 'AC', 'NP']" class="inline-block ml-2 mb-2">
                            <PrimaryButton v-if="filter.lamp === lamp" @click="filter.lamp = null">{{
                                lamp
                            }}</PrimaryButton>
                    ...
                    <div>
                        ...
                        <span
                            v-for="grade in ['AAA', 'AA', 'A', 'B', 'C', 'D', 'E', 'F']"
                            class="inline-block ml-2 mb-2"
                        >
                            <PrimaryButton v-if="filter.grade === grade" @click="filter.grade = null">{{
                                grade
                            }}</PrimaryButton>
